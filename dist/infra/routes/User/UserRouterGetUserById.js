...
const UserFactoryGetUserById_1 = require("../../factory/User/UserFactoryGetUserById");
function UserRouterGetUserById() {
    return __awaiter(this, void 0, void 0, function* () {
        const user = yield (0, UserFactoryGetUserById_1.UserFactoryGetUserById)();
     ...
     */
        router.get("/users/:id", (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield user.getUserById(req, res);
            }
            catch (error) {
...
exports.default = UserRouterGetUserById;
